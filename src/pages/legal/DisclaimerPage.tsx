      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="prose prose-invert max-w-none text-gray-300">
            ...
            <h2 className="text-xl font-semibold text-white mt-8 mb-4">3. No Guarantees</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-white mt-8 mb-4">4. External Links</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-white mt-8 mb-4">5. No Professional Advice</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-white mt-8 mb-4">7. "AS IS" and "AS AVAILABLE" Disclaimer</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-white mt-8 mb-4">8. Accuracy of Materials</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-white mt-8 mb-4">9. Changes to Disclaimer</h2>
            <p>
